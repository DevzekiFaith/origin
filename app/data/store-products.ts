import { Book, Shirt, PenTool, Award, Sparkles, LucideIcon } from "lucide-react";
...
export const STORE_PRODUCTS: StoreProduct[] = [
  {
    ...
    rawDescription: "<h3>We start with your dreams before educating you.</h3><p>Optimize your daily routines, track your progress, and align your daily execution through the 3-part Origin framework: <strong>Dream (Days 1–7) → Education (Days 8–14) → Purpose (Days 15–21)</strong>. Built for thinkers, builders, and high achievers.</p><br><h3>Included Digital &amp; Interactive Access</h3><ul><li><strong>Origin 21-Day Digital Master Kit (PDF):</strong> Complete 21-day fillable planner (Days 1–7 Dream, Days 8–14 Education, Days 15–21 Purpose) + Founder Audio Sprint Script.</li><li><strong>Free 7-Day Micro-Sprint Starter (PDF):</strong> Immediate 7-day quickstart focus guide.</li></ul>"
  },
  {
    id: 3,
    name: "Origin Hoodie",
  ...
  },
  {
    ...
    galleryImages: [
      "/cover_money_farming.png",
      "/images/store/money_farming_woman.jpg",
      "/images/store/money_farming_igbo_man.jpg"
    ],
  ...
  },
  {
    ...
    galleryImages: [
      "/8-qa-to-selling.png",
      "/images/store/8_qa_selling_corporate.jpg",
      "/images/store/8_qa_selling_native.jpg"
    ],
  ...
  },
  {
    ...
    icon: Book,
    gradient: "from-[#60a5fa]/10 to-[#60a5fa]/5",
    imageUrl: "/images/store/cover_house_of_choice_orig.jpg",
    galleryImages: [
      "/images/store/cover_house_of_choice_orig.jpg",
      "/images/store/house_of_choice_corporate.jpg",
      "/images/store/house_of_choice_native.jpg"
    ],
  ...
  },
  {
    ...
    bonusPdfs: [
      ...
      { name: "POI Authority Positioning Worksheet (PDF)", url: "", size: "Live Masterclass Worksheet" },
  ...
  },
  {
    ...
    description: "Prepare for profit in your career, work, ministry, and significance. Available in dual-mode (Global Virtual Stream & Onsite Regional Workshops across Nigerian states), featuring the Fit For Profit Impact Corps for schools and local communities.",
    ...
    rawDescription: "<h1>Fit-For-Profit Workshop</h1><p><strong>Prepare for profit in your career, work, ministry, and significance.</strong></p><p>Fit-For-Profit is a monthly regional workshop designed to structurally audit and build personal and professional capacity. Available via <strong>Global Virtual Live Stream</strong> from anywhere worldwide, or <strong>Onsite at our Multi-State Physical Centers</strong> (Lagos, Abuja, Uyo, Port Harcourt).</p><br><h2>What You Stand to Gain After Registration</h2><ul><li><strong>Commercial &amp; Career Capacity Audit:</strong> Position your professional assets for elite demand, eliminate structural career flaws, and command premium scale.</li><li><strong>Purpose, Ministry &amp; Significance Alignment:</strong> Align your unique calling with highly impactful, sustainable execution structures that create lasting value.</li><li><strong>Dual-Mode Attendance Guarantee:</strong> Join live virtually from any country or attend physical regional workshop centers.</li><li><strong>Localized Founder &amp; Intrapreneur Network:</strong> Connect directly with regional founders, business owners, and corporate leaders across multi-state monthly sessions.</li><li><strong>Fit For Profit Impact Corps Access:</strong> Gain direct eligibility to step up and lead community service drives for schools, education platforms, and local youth initiatives.</li><li><strong>Live Workshop Tools &amp; Audit Sheets:</strong> Receive purpose-built worksheets, a commercial capacity audit sheet, vocation-to-profit alignment grid, and sales objection practice sheet — all completed live with facilitator guidance during the session.</li></ul><br><h3>Recommended Companion Resources</h3><p>To deepen your workshop results, we recommend picking up these Origin companion reads from the <a href='/store' style='color:#1C3B34;text-decoration:underline;font-weight:bold;'>Origin Store</a>:</p><ul><li><strong>Money Farming</strong> — The 7 principles for planting and harvesting sustainable wealth.</li><li><strong>8 Q&amp;A to Selling</strong> — The definitive blueprint for market authority and premium positioning.</li></ul><br><h3>Key Workshop Focus Areas</h3><ul><li><strong>Career &amp; Work:</strong> Positioning your professional assets for elite demand and command premium scale.</li><li><strong>Ministry &amp; Significance:</strong> Aligning your unique calling with highly impactful execution structures.</li><li><strong>Monthly Regional Targets:</strong> Staged in different states every month to build localized networks of founders and intrapreneurs.</li><li><strong>Fit For Profit Impact Corps Arm:</strong> Join our community service programs and educational outreaches for schools, education platforms, and local communities.</li></ul><br><h3>Early-Founders &amp; Intrapreneurs Discount</h3><p>Standard Ticket: <del>₦58,872</del></p><p>Early-Founder / Early-Business Owner / Intrapreneur Ticket: <strong>₦12,000</strong></p>"
  },
  {
    id: 17,
    ...
    description: "An intensive 2-Day Live Transformational Accelerator available in dual-mode (Global Virtual Stream + Regional Onsite Hubs) combining cognitive psychology, value alignment, and strategic execution blueprints with a 21-day cognitive sprint.",
