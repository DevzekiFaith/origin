...
These advanced techniques prepare you for the most demanding decision situations.`,
        ...
        resources: [
          ...
          { name: "Decision-Making Mastery — Official Course Workbook (PDF)", url: "/documents/course-decision-making-workbook.pdf", type: "template", downloadable: true }
        ],
        estimatedTime: "60 minutes"
      }
    ],
    ...
    detailedModules: [
      ...
      },
      {
        ...
        resources: [
          ...
          { name: "Team Person — Official Course Workbook (PDF)", url: "/documents/course-team-person-workbook.pdf", type: "template", downloadable: true }
        ],
        estimatedTime: "40 minutes"
      }
    ]
    ...
    detailedModules: [
      ...
      },
      {
        ...
        resources: [
          ...
          { name: "Communication Mastery — Official Course Workbook (PDF)", url: "/documents/course-communication-workbook.pdf", type: "pdf", downloadable: true },
