...
export const metadata: Metadata = {
  ...
  title: {
    default: "Origin — Unconventional Learning Platform | School Starts with the Answer. Origin Starts with the Question.",
    template: "%s | Origin — Unconventional Learning Platform",
  },
  description: "Origin is building practical thinkers. Master economic principles, high-stakes decision making, and practical life architecture through interactive experiences, challenges, and learning companions.",
  keywords: [
    "Origin",
    "origin.com.ng",
    "unconventional learning",
    "practical thinking for teenagers",
