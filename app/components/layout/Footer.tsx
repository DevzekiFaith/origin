        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/#volunteer" className="text-[#9aa4b2] hover:text-[#60a5fa] transition-colors font-medium flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-emerald-400"></span> Fit For Profit Impact Corps</Link></li>
