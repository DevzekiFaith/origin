    ...
    <section id="question-discovery" className="py-24 sm:py-32 bg-[#FAFAF8] text-[#121316] border-b border-[#E8E8E3] relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-14">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#F3F3EE] border border-[#E2E2DC] text-xs font-mono text-[#52525B] mb-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
              ...
              return (
                <button
                  ...
                  className={`w-full text-left p-5 rounded-2xl border transition-all duration-200 flex items-center justify-between gap-4 cursor-pointer ${
                    isSelected
                      ? "bg-[#FFFFFF] border-amber-600 shadow-[0_4px_20px_rgba(0,0,0,0.05)] ring-1 ring-amber-600/30"
                      : "bg-[#FFFFFF]/70 border-[#E8E8E3] text-[#52525B] hover:border-[#D4D4CE] hover:bg-[#FFFFFF] hover:text-[#121316]"
                  }`}
                >
                  <div className="flex items-start gap-3.5">
                    <span className={`w-2.5 h-2.5 rounded-full mt-2 shrink-0 ${isSelected ? "bg-amber-600" : "bg-[#D4D4CE]"}`} />
                    <div>
          ...
          <div className="lg:col-span-6 sticky top-28">
            <div className="p-7 sm:p-9 rounded-3xl bg-[#FFFFFF] border border-[#E2E2DC] shadow-[0_10px_35px_rgba(0,0,0,0.04)] relative overflow-hidden">
