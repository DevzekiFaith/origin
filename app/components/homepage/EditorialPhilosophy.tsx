    ...
    <section className="py-24 sm:py-32 bg-[#FAFAF8] text-[#121316] border-b border-[#E8E8E3]">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="p-8 sm:p-14 md:p-16 rounded-3xl bg-[#FFFFFF] border border-[#E2E2DC] text-center mb-20 shadow-[0_12px_40px_rgba(0,0,0,0.03)] relative overflow-hidden"
        >
          ...
          {[
            ...
            return (
              <motion.div
                ...
                className="p-6 rounded-2xl bg-[#FFFFFF] border border-[#E8E8E3] shadow-xs"
              >
                <Icon className="w-6 h-6 text-amber-600 mb-3" />
                <h3 className="text-base font-bold text-[#121316] mb-1">{item.title}</h3>
        ...
        <div className="max-w-3xl mx-auto">
          <motion.h3
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-2xl sm:text-3xl font-bold text-[#121316] text-center mb-8"
          >
                  ...
                  <AnimatePresence>
                    {isOpen && (
                      <motion.div
                        ...
                        className="px-5 pb-5 text-sm text-[#52525B] leading-relaxed border-t border-[#F0F0EB] pt-3"
                      >
                        {faq.a}
                      </motion.div>
                    )}
