...
const THESIS_SLIDES: ThesisSlide[] = [
  ...
  {
    id: "loop",
    category: "02 · THE 4-STAGE THINKING FRAMEWORK",
    tabLabel: "The Journey",
    headline: "Think → Experience → Challenge → Apply",
    description:
      "Every Origin Foundation guides you through an intentional four-stage architecture: think through unexamined assumptions, immerse in real-world friction, navigate high-stakes challenge choices, and apply proven mental models to life.",
    metricNumber: "4 Stages",
    metricLabel: "Think · Experience · Challenge · Apply",
    cardName: "The Thinking Journey",
    cardSubtitle: "Experiential learning & decision architecture",
